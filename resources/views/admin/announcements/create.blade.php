            ...
            <form action="{{ route('admin.announcements.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="active" id="active" value="1" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" checked>
                    ...
                    <div class="flex justify-end">
                        ...
                        <button type="submit" class="bg-indigo-600 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Create Announcement</button>
                    </div>
                </div>
            </form>
        </div>
