                ...
                <div class="flex flex-col lg:flex-row gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2">
                        ...
                        <select name="sort_by" 
                            ...
                            <option value="membership_expiry" {{ request('sort_by') == 'membership_expiry' ? 'selected' : '' }}>Sort: Expiry Date</option>
                        </select>
                    </div>
                </div>
            </form>
                            ...
                            <tr class="hover:bg-white hover:bg-opacity-30 transition">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            @if($member->avatar)
                                                <img src="{{ asset('storage/' . $member->avatar) }}" alt="{{ $member->name }}" class="h-12 w-12 rounded-full object-cover shadow-md">
                                            @else
