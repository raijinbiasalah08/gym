    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
        <div class="text-center mb-16">
            <h1 class="text-4xl md:text-5xl font-display font-bold text-gray-900 mb-6">
                About <span class="bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">TitansGym</span>
            </h1>
        ...
        <!-- Stats -->
        <div class="bg-gradient-to-r from-orange-600 to-red-600 rounded-3xl p-12 text-white mb-20 shadow-xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="glass-card rounded-xl overflow-hidden group">
                ...
                <div class="p-6 text-center">
                    ...
                    <p class="text-orange-600 font-medium mb-4">CEO & Founder</p>
                    <p class="text-gray-600 text-sm mb-4">
                        Visionary leader with over 15 years in the fitness and tech industries.
                    </p>
                    <div class="flex justify-center space-x-4">
                        <a href="#" class="text-gray-400 hover:text-orange-600 transition"><i class="fab fa-linkedin"></i></a>
